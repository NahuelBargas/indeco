...
valueBox("0.9 %", caption = "Aumento del EMAE desestacionalizado de Diciembre-20 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("-10 %", caption = "Variación acumulada del año(2020) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
...
### Balanza comercial, primer mes del 2021
...
impo <- tibble(
  ...
  y = c(3844,725,1416,266,744,501,41.1,32),
  drilldown = tolower(name)
)
...
y = c(2,87,11,49,21,779,81,8,4,3,26,8) )
...
name = c("Carnes y sus preparados",
  ...
  "Lanas elaboradas",
  "Resto de MOA"),
y=c(254,16,122,6,5,10,70,660,17,42,66,1104,20,31,7,30))
...
name= c(  "Productos químicos y conexos",
  ...
  "Resto de MOI"),
y= c(265,64,17,2,34,9,0,10,151,64,87,294,3,22))
...
y=c(48,72,527,210,62,65,41,278,112))
...
y=c(17,47,46,172,30,18,17,40,29,20,34,31))
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primer mes del 2021",style = list( fontSize = '12px')) %>%
