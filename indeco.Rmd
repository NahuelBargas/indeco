...
valueBox("1.1 %", caption = "Aumento del EMAE desestacionalizado de Julio-20 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("-12.6 %", caption = "Variación acumulada del año(Primeros siete meses - 20) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
...
### Balanza comercial, primeros ocho meses del 2020
...
impo <- tibble(
  ...
  y = c(26245,4347,10530,1991,4478,3821,877,201),
  drilldown = tolower(name)
)
...
expo <- tibble(
  ...
  y = c(37229,12548,14310,8191,2180),
  drilldown = tolower(name)
)
...
y = c(12,958,125,488,548,7122,2907,94,16,58,148,73))
...
name = c("Carnes y sus preparados",
  ...
  "Lanas elaboradas",
  "Resto de MOA"),
y=c(2226,141,572,44,62,109,448,3198,131,478,555,5698,125,221,52,251))
...
name= c(  "Productos químicos y conexos",
  ...
  "Resto de MOI"),
y= c(2075,478,106,10,247,61,2,62,1290,857,649,2122,65,167))
...
y=c(1571,305,4314,1347,529,390,208,1099,768))
...
y=c(93,292,374,1453,169,328,201,268,137,102,198,205))
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primeros ocho meses del 2020",style = list( fontSize = '12px')) %>%
...
- Estados Unidos incluye Puerto Rico y territorios asociados, China a Macao. Chile, Uruguay y Brasil, sus zonas francas.
- Última actualización: 24/9/2020.
