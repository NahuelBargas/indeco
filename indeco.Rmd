...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_junio21.xlsx", sheet=2,startRow = 7,colNames=FALSE)
...
valueBox("-2.0 %", caption = "Descenso del EMAE desestacionalizado de Mayo-21 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("9.5 %", caption = "Variación acumulada del año(2021) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="orangered")
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2021/07/resultado_-_jun21.xls")
...
hc_title(text="Resultado Fiscal- Base Caja- Junio 2021.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Junio 2021- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
