...
basezonas<-read.xlsx("bases/basezonas14.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_julio21.xlsx", sheet=2,startRow = 7,colNames=FALSE)
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = " https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_07_21.xls")%>%
...
valueBox("2.5 %", caption = "Descenso del EMAE desestacionalizado de Junio-21 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("9.7 %", caption = "Variación acumulada del año(2021) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="orangered")
...
### Balanza comercial, primeros siete meses del 2021
...
impo <- tibble(
  ...
  y = c(34314,5408,14073,2999,6530,3935,1057,313
...
expo <- tibble(
  ...
  y = c(42625,11870,18058,10412,2284
...
y = c(16,907,143,338,434,7532,2004,82,31,67,234,82
...
name = c("Carnes y sus preparados",
  ...
  "Lanas elaboradas",
  "Resto de MOA"),
y=c(1861,136,589,38,52,95,442,5140,134,407,527,7935,141,237,68,256
...
name= c(  "Productos químicos y conexos",
  ...
  "Resto de MOI"),
y= c(2735,509,123,15,236,66,4,89,1295,807,755,3323,152,304
...
y=c(2021,712,5271,1741,484,555,301,2105,883
...
y=c(128,300,414,1281,282,195,232,293,231,123,231,227
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primeros siete meses del 2021",style = list( fontSize = '12px')) %>%
...
- Estados Unidos incluye Puerto Rico y territorios asociados, China a Macao. Chile, Uruguay y Brasil, sus zonas francas.
- Última actualización: 21/8/2021.
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2021/08/resultado-jul21.xls")
...
hc_title(text="Resultado Fiscal- Base Caja- Julio 2021.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Julio 2021- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
