...
regiones<-read.xlsx("bases/opex 2ndo semestre 2024.xlsx",sheet=1)

provincias<-jsonlite::fromJSON("bases/provincias.geojson", simplifyVector = FALSE)

complejos<-read.xlsx("bases/opex 2ndo semestre 2024.xlsx",sheet=2)
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = " https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_08_25.xls")%>%		 
...
Origen provincial de las exportaciones y complejos exportadores - 2024 {data-orientation=columns data-navmenu="Comercio Exterior"}
==================================================================================================================================
...
hc_credits(enabled=TRUE, text="2ndo semestre 2024.Fuente: INDEC", position =list( align ="left", x=20))
...
complejos<-complejos[-c(1,2,7,14,21,24,33),-2]
...
hc_colorAxis(minColor =cols15[1],
  ...
  hc_title(text="Complejos exportadores, desagregados por regiones económicas. Acumulado 2ndo semestre 2024")%>%
