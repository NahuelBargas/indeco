...
trimestre<-seq(as.Date("2016-04-01"), length = 38,by = "3 months")
...
basezonas<-read.xlsx("bases/basezonas62.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_febrero26.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
```{r}
valueBox("5.9 %", caption = "Acumulada en lo que va del año",  color="skyblue")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = "https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_03_26.xls")%>%		 
...
valueBox("0.4 %", caption = "Variación del EMAE desestacionalizado de Ene.-26 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("1.9 %", caption = "Variación acumulada del año(2026) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="#43ac6a")
...
hc_tooltip(pointFormat =  "{point.y:.1f} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primer bimestre de 2026",style = list( fontSize = '12px')) %>%
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2026/03/sector_publico_base_caja_febrero_2026.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja-Febrero 2026. Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Febrero 2026 - Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
