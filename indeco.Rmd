...
basezonas<-read.xlsx("bases/basezonas31.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_diciembre_2022.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
valueBox("-0.7 %", caption = "Variación del EMAE desestacionalizado de Noviembre-22 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("5.9 %", caption = "Variación acumulada del año(2022) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="orangered")
...
### Balanza comercial, doce meses de 2022
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado doce meses de 2022",style = list( fontSize = '12px')) %>%
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2023/01/sector_publico_base_caja_-_diciembre_2022_1.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja- Diciembre 2022.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Diciembre 2022- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
