...
trimestre<-seq(as.Date("2016-04-01"), length = 33,by = "3 months")
...
basezonas<-read.xlsx("bases/basezonas49.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_septiembre2024.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
valueBox("0.2 %", caption = "Variación del EMAE desestacionalizado de Ago-24 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2024/10/sector_publico_base_caja_septiembre_2024.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja-Septiembre 24. Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Septiembre 2024 - Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
