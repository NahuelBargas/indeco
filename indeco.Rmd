...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal-oct20.xlsx", sheet=2,startRow = 7,colNames=FALSE)
...
valueBox("1.9 %", caption = "Aumento del EMAE desestacionalizado de Septiembre-20 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("-11.9 %", caption = "Variación acumulada del año(Primeros nueve meses - 20) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/resultado_fiscal-oct20.xls")
...
hc_title(text="Resultado Fiscal- Base Caja- Octubre 2020.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja- Octubre 2020- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
