...
trimestre<-seq(as.Date("2016-04-01"), length = 22,by = "3 months")
...
valueBox("1.1 %", caption = "Descenso del EMAE desestacionalizado de Noviembre-21 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("10.8 %", caption = "Variación acumulada del año(2021) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="orangered")
