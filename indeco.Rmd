...
```{r}
valueBox("80.2 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
### Tasa de incidencia de la pobreza e indigencia- 2ndo Semestre 2022- Aglomerados
...
### Pobreza e indigencia-2ndo semestre 2022-Regiones
...
valueBox("-0.2 %", caption = "Variación del EMAE desestacionalizado de Mayo-23 con respecto al mes anterior",icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("-1.9 %", caption = "Variación acumulada del año(2023) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
