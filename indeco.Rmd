...
valueBox("0.3 %", caption = "Variación del EMAE desestacionalizado de Enero-23 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("2.9 %", caption = "Variación acumulada del año(2023) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="orangered")
