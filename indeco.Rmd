...
basezonas<-read.xlsx("bases/basezonas45.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_abril2024.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
valueBox("-1.4 %", caption = "Variación del EMAE desestacionalizado de Marzo-24 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("-5.3 %", caption = "Variación acumulada del año(2024) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
...
hc_tooltip(pointFormat =  "{point.y:.1f} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primer cuatrimestre de 2024",style = list( fontSize = '12px')) %>%
...
- Estados Unidos incluye Puerto Rico y territorios asociados, China a Macao. Chile, Uruguay y Brasil, sus zonas francas.
- Última actualización: 25/5/2024.
