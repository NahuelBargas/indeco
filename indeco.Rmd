...
valueBox("3.5 %", caption = "Variación del EMAE desestacionalizado de Mar.-26 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("1.7 %", caption = "Variación acumulada del año(2026) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="#43ac6a")#"color="yellow")
