...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_noviembre_2023.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
valueBox("-0.1 %", caption = "Variación del EMAE desestacionalizado de Octubre-23 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("-1.4 %", caption = "Variación acumulada del año(2023) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
...
### Balanza comercial, once meses de 2023
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado once meses de 2023",style = list( fontSize = '12px')) %>%
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2023/12/noviembre-2023.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja- Noviembre 2023.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Noviembre 2023- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
