...
basezonas<-read.xlsx("bases/basezonas54.xlsx", sheet=1)
...
valueBox("0.8 %", caption = "Variación del EMAE desestacionalizado de Feb-25 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("6.2 %", caption = "Variación acumulada del año(2025) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="skyblue")
