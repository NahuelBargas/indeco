...
### Balanza comercial, primeros diez meses del 2020
...
impo <- tibble(
  ...
  y = c(34385,5768,13808,2385,5942,4938,1257,287),
  drilldown = tolower(name)
)
...
expo <- tibble(
  ...
  y = c(46556,14688,18444,10817,2608),
  drilldown = tolower(name)
)
...
y = c(13,1303,150,596,613,8238,3212,163,19,83,201,97))
...
name = c("Carnes y sus preparados",
  ...
  "Lanas elaboradas",
  "Resto de MOA"),
y=c(2837,179,787,56,94,135,579,4150,191,609,724,7288,167,269,65,314))
...
name= c(  "Productos químicos y conexos",
  ...
  "Resto de MOI"),
y= c(2695,593,7134,13,301,80,3,85,1668,1064,849,3031,75,225))
...
y=c(2024,411,5657,1739,668,521,283,1513,992))
...
y=c(118,398,480,1854,228,383,252,354,200,130,269,271))
