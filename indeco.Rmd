...
```{r}
valueBox("8.6 %", caption = "Acumulada en lo que va del año",  color="skyblue")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = " https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_04_25.xls")%>%		 
...
valueBox("0.6 %", caption = "Variación del EMAE desestacionalizado de Ene-25 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("6.5 %", caption = "Variación acumulada del año(2025) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="skyblue")
