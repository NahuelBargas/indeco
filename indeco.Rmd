...
basezonas<-read.xlsx("bases/basezonas41.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_octubre_2023.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
```{r}
valueBox("148.2 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = " https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_12_23.xls")%>%		 
...
valueBox("0.0 %", caption = "Variación del EMAE desestacionalizado de Septiembre-23 con respecto al mes anterior", color="skyblue")
###icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("-1.5 %", caption = "Variación acumulada del año(2023) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
...
### Balanza comercial, primeros diez meses de 2023
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primeros diez meses de 2023",style = list( fontSize = '12px')) %>%
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2023/11/octubre-2023.xls")
...
hc_title(text="Resultado Fiscal- Base Caja- Octubre 2023.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Octubre 2023- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
