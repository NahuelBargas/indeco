...
basezonas<-read.xlsx("bases/basezonas66.xlsx", sheet=1)
...
valueBox("-0.5 %", caption = "Variación del EMAE desestacionalizado de May.-26 con respecto al mes anterior", icon="glyphicon-arrow-down",color="yellow")
...
hc_tooltip(pointFormat =  "{point.y:.1f} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primer semestre de 2026",style = list( fontSize = '12px')) %>%
...
- Estados Unidos incluye Puerto Rico y territorios asociados, China a Macao. Chile, Uruguay y Brasil, sus zonas francas.
- Última actualización: 25/7/2026.
