...
trimestre<-seq(as.Date("2016-04-01"), length = 37,by = "3 months")
...
basezonas<-read.xlsx("bases/basezonas60.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_diciembre25.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
```{r}
valueBox("31.5 %", caption = "Acumulada en lo que va del año",  color="skyblue")
```
...
Balanza comercial, acumulado en 2025 {data-navmenu="Comercio Exterior"}
=========================================================================


### Balanza comercial, acumulado 2025
...
hc_tooltip(pointFormat =  "{point.y:.1f} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado doce meses de 2025",style = list( fontSize = '12px')) %>%
hc_subtitle(text="INDEC - Datos Estimados. Millones de dólares. Cliquear para desplegar.",style = list(color = "#2b908f", fontSize = '10px')) %>%
  hc_exporting(enabled = TRUE) %>% hc_add_theme(temaclásico)

```

Saldo y comercio exterior total, por zona zona económica - 2025 {data-navmenu="Comercio Exterior"}
=================================================================================
...
hc_colorAxis(minColor =cols9[1],
  ...
  hc_title(text="Saldo balanza comercial e intercambio total, por zona económica y país. Acumulado 2025")%>%
...
Total comerciado, por país y continente - 2025 {data-navmenu="Comercio Exterior"}
=================================================================================


## Saldo balanza comercial e intercambio total, por continente y país. Acumulado 2025
...
- Estados Unidos incluye Puerto Rico y territorios asociados, China a Macao. Chile, Uruguay y Brasil, sus zonas francas.
- Última actualización: 24/1/2026.
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2026/01/sector_publico_base_caja_diciembre_2025.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja-Diciembre 2025. Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Diciembre 2025 - Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
