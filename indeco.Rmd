...
trimestre<-seq(as.Date("2016-04-01"), length = 23,by = "3 months")
...
basezonas<-read.xlsx("bases/basezonas23.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado-fiscal_marzo_2022.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
```{r}
valueBox("23.1 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = " https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_05_22.xls")%>%		 
...
valueBox("0.7 %", caption = "Descenso del EMAE desestacionalizado de Marzo-22 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("6.1 %", caption = "Variación acumulada del año(2022) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="orangered")
...
### Balanza comercial, primer cuatrimestre del 2022
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primer cuatrimestre del 2022",style = list( fontSize = '12px')) %>%
...
- Estados Unidos incluye Puerto Rico y territorios asociados, China a Macao. Chile, Uruguay y Brasil, sus zonas francas.
- Última actualización: 20/5/2022.
...
hc_title(text="Resultado Fiscal- Base Caja- Marzo 2022.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hcrs2 <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2022/04/resultado-fiscal_marzo-2022.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja-Marzo 2022- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
