...
basezonas<-read.xlsx("bases/basezonas35.xlsx", sheet=1)
...
valueBox("0.1 %", caption = "Variación del EMAE desestacionalizado de Marzo-23 con respecto al mes anterior",icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("1.5 %", caption = "Variación acumulada del año(2023) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="orangered")
