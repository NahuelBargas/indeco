...
basezonas<-read.xlsx("bases/basezonas59.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_noviembre25.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
valueBox("-0.4 %", caption = "Variación del EMAE desestacionalizado de Oct.-25 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("5.0 %", caption = "Variación acumulada del año(2025) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="#43ac6a")
...
hc_tooltip(pointFormat =  "{point.y:.1f} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado once meses de 2025",style = list( fontSize = '12px')) %>%
