...
regiones<-read.xlsx("bases/opex 1er semestre 2025.xlsx",sheet=1)

provincias<-jsonlite::fromJSON("bases/provincias.geojson", simplifyVector = FALSE)

complejos<-read.xlsx("bases/opex 1er semestre 2025.xlsx",sheet=2)
...
```{r}
valueBox("2.9 %", caption = "Acumulada en lo que va del año",  color="skyblue")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = "https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_01_26.xls")%>%		 
...
valueBox("-0.3 %", caption = "Variación del EMAE desestacionalizado de Nov.-25 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("4.5 %", caption = "Variación acumulada del año(2025) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="#43ac6a")
...
hc_credits(enabled=TRUE, text="1er. semestre 2025.Fuente: INDEC", position =list( align ="left", x=20))
