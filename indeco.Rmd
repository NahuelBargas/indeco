...
regiones<-read.xlsx("bases/opex 1er semestre 2024.xlsx",sheet=1)

provincias<-jsonlite::fromJSON("bases/provincias.geojson", simplifyVector = FALSE)

complejos<-read.xlsx("bases/opex 1er semestre 2024.xlsx",sheet=2)
...
```{r}
valueBox("2.2 %", caption = "Acumulada en lo que va del año",  color="skyblue")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = " https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_02_25.xls")%>%		 
...
valueBox("0.9 %", caption = "Variación del EMAE desestacionalizado de Nov-24 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("-2.5 %", caption = "Variación acumulada del año(2024) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
...
hc_credits(enabled=TRUE, text="1er semestre 2024.Fuente: INDEC", position =list( align ="left", x=20))
...
complejos<-complejos[-c(1,2,7,13,17,24,33),-2]
...
hc_colorAxis(minColor =cols15[1],
  ...
  hc_title(text="Complejos exportadores, desagregados por regiones económicas. Acumulado 1er semestre 2024")%>%
