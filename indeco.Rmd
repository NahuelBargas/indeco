...
basezonas<-read.xlsx("bases/basezonas55.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_abril2025.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
```{r}
valueBox("11.6 %", caption = "Acumulada en lo que va del año",  color="skyblue")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = " https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_05_25.xls")%>%		 
...
valueBox("-1.8 %", caption = "Variación del EMAE desestacionalizado de Abr-25 con respecto al mes anterior", icon="glyphicon-arrow-down",color="yellow")
...
valueBox("6.1 %", caption = "Variación acumulada del año(2025) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="skyblue")
...
hc_colors(cols8)%>%
hc_title(text=" Valor agregado bruto a precios básicos,por categorías, tercer trimestre del 2024",style = list(color = "black", fontSize = '14px')) %>%
...
hc_tooltip(pointFormat =  "{point.y:.1f} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primer cuatrimestre de 2025",style = list( fontSize = '12px')) %>%
...
- Estados Unidos incluye Puerto Rico y territorios asociados, China a Macao. Chile, Uruguay y Brasil, sus zonas francas.
- Última actualización: 23/5/2025.
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2025/05/sector_publico_base_caja_abril_2025.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja-Abril 2025. Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Abril 2025 - Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
