...
trimestre<-seq(as.Date("2016-04-01"), length = 30,by = "3 months")
...
basezonas<-read.xlsx("bases/basezonas43.xlsx", sheet=1)
...
```{r}
valueBox("51.6 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = " https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_04_24.xls")%>%		 
...
Saldo y comercio exterior total, por zona zona económica - 2023 {data-navmenu="Comercio Exterior"}
=================================================================================
...
hc_colorAxis(minColor =cols9[1],
  ...
  hc_title(text="Saldo balanza comercial e intercambio total, por zona económica y país. Acumulado 2023")%>%
...
Total comerciado, por país y continente - 2023 {data-navmenu="Comercio Exterior"}
=================================================================================


## Saldo balanza comercial e intercambio total, por continente y país. Acumulado 2023
...
spanish<-'{
	...
	"sLengthMenu":     "Mostrar _MENU_ filas - Acumulado 2023",
...
- Estados Unidos incluye Puerto Rico y territorios asociados, China a Macao. Chile, Uruguay y Brasil, sus zonas francas.
- Última actualización: 25/1/2024.
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2024/04/imig_marzo_2024.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja-Marzo 24.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Marzo 2024- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
