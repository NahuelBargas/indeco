...
```{r}
valueBox("37.0 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = " https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_10_21.xls")%>%
...
valueBox("0.8 %", caption = "Aumento del EMAE desestacionalizado de Julio-21 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("10.5 %", caption = "Variación acumulada del año(2021) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="orangered")
