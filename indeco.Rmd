...
valueBox("1.8 %", caption = "Variación del EMAE desestacionalizado de Dic.-25 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("4.4 %", caption = "Variación acumulada del año(2025) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="#43ac6a")
