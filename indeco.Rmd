...
basezonas<-read.xlsx("bases/basezonas63.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_marzo26.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
```{r}
valueBox("12.3 %", caption = "Acumulada en lo que va del año",  color="skyblue")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = "https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_05_26.xls")%>%		 
...
valueBox("-2.6 %", caption = "Variación del EMAE desestacionalizado de Feb.-26 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("-0.2 %", caption = "Variación acumulada del año(2026) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="yellow")#color="#43ac6a")
...
hc_tooltip(pointFormat =  "{point.y:.1f} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primer trimestre de 2026",style = list( fontSize = '12px')) %>%
...
- Estados Unidos incluye Puerto Rico y territorios asociados, China a Macao. Chile, Uruguay y Brasil, sus zonas francas.
- Última actualización: 25/4/2026.
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2026/04/imig_marzo_20261.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja-Marzo 2026. Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Marzo 2026 - Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
