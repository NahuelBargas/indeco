...
```{r}
valueBox("7.8 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
valueBox("1.9 %", caption = "Aumento del EMAE desestacionalizado de Enero-21 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("-2 %", caption = "Variación acumulada del año(2021) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
...
### Balanza comercial, primer bimestre del 2021
...
impo <- tibble(
  ...
  y = c(7556,1445,2825,440,1488,950,331,67),
  drilldown = tolower(name)
)
...
y = c(4,223,29,91,69,1459,165,24,8,10,54,18) )
...
name = c("Carnes y sus preparados",
  ...
  "Lanas elaboradas",
  "Resto de MOA"),
y=c(496,33,193,11,9,25,119,1186,36,92,132,2053,38,61,18,59))
...
name= c(  "Productos químicos y conexos",
  ...
  "Resto de MOI"),
y= c(559,112,29,4,64,17,1,20,325,168,177,713,3,104))
...
y=c(83,178,1050,418,121,136,81,530,227))
...
y=c(31,87,104,295,62,39,41,78,57,34,60,61))
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primer bimestre del 2021",style = list( fontSize = '12px')) %>%
