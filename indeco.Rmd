...
valueBox("0.7 %", caption = "Aumento del EMAE desestacionalizado de Abril-22 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("5.7 %", caption = "Variación acumulada del año(2022) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
