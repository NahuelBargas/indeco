...
Column {style="width:85pc;height:90pc"}
--------------------------------------------------------------
...
valueBox("-1.2 %", caption = "Descenso del EMAE desestacionalizado de Abril-21 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("8.2 %", caption = "Variación acumulada del año(2021) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="orangered")
