...
basezonas<-read.xlsx("bases/basezonas20.xlsx", sheet=1)
...
valueBox("0.9 %", caption = "Aumento del EMAE desestacionalizado de Diciembre-21 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("10.3 %", caption = "Variación acumulada del año(2021) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="orangered")
...
impo <- tibble(
  ...
  y = c(5251,998,2076,363,966,682,119,48
...
y = c(3,95,14,56,19,1561,102,17,2,26,0,0
...
name = c("Carnes y sus preparados",
  ...
  "Lanas elaboradas",
  "Resto de MOA"),
y=c(264,15,123,4,4,14,68,490,17,45,49,658,24,38,6,38
...
name= c(  "Productos químicos y conexos",
  ...
  "Resto de MOI"),
y= c(512,91,14,2,33,10,1,9,183,87,106,271,1,21
...
y=c(25,107,790,326,98,122,64,385,159
...
y=c(26,48,62,180,54,31,48,51,49,24,56,52
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primer mes del 2022",style = list( fontSize = '12px')) %>%
