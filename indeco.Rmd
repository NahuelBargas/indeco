...
valueBox("0.6 %", caption = "Variación del EMAE desestacionalizado de Oct-24 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("-2.7 %", caption = "Variación acumulada del año(2024) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
