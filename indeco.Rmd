...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_mayo26.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
```{r}
valueBox("14.7 %", caption = "Acumulada en lo que va del año",  color="skyblue")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = "https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_06_26.xls")%>%		 
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2026/06/imig_mayo_2026.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja-Mayo 2026. Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Mayo 2026 - Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
