...
```{r}
valueBox("27.9 %", caption = "Acumulada en lo que va del año",  color="skyblue")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = "https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_12_25.xls")%>%		 
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2025/12/sector_publico_base_caja_noviembre_2025.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja-Noviembre 2025. Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Noviembre 2025 - Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
