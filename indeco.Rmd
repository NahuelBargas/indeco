...
```{r}
valueBox("2.7 %", caption = "Inflación del mes de Agosto-2020", icon="glyphicon-arrow-up",color="skyblue")
```
...
```{r}
valueBox("40.7 %", caption = "Variación interanual", icon="glyphicon-arrow-down",color="orangered")
```

### Acumulada en el año.

```{r}
valueBox("18.9 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = "https://www.indec.gob.ar/uploads/informesdeprensa/ipc_09_20D39002C437.pdf")%>%
...
### Variación mensual según divisiones-Agosto 2020
...
### Variación interanual según divisiones-Agosto 2020
