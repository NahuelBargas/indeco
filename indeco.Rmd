...
regiones<-read.xlsx("bases/opex 1er semestre 2022.xlsx",sheet=1)

provincias<-jsonlite::fromJSON("bases/provincias.geojson", simplifyVector = FALSE)

complejos<-read.xlsx("bases/opex 1er semestre 2022.xlsx",sheet=2)
...
hc_colorAxis(minColor =cols15[1],
  ...
  hc_title(text="Complejos exportadores, desagregados por regiones económicas. Acumulado 1er. semestre del 2022")%>%
