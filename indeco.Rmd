...
basezonas<-read.xlsx("bases/basezonas11.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_marzo_2021.xlsx", sheet=2,startRow = 7,colNames=FALSE)
...
- Estados Unidos incluye Puerto Rico y territorios asociados, China a Macao. Chile, Uruguay y Brasil, sus zonas francas.
- Última actualización: 24/4/2021.
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/resultado_fiscal_marzo_2021.xls")
...
hc_title(text="Resultado Fiscal- Base Caja- Marzo 2021.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Marzo 2021- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
