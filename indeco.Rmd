...
basezonas<-read.xlsx("bases/basezonas51.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_diciembre2024.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
hc_tooltip(pointFormat =  "{point.y:.1f} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado doce meses de 2024",style = list( fontSize = '12px')) %>%
...
- Estados Unidos incluye Puerto Rico y territorios asociados, China a Macao. Chile, Uruguay y Brasil, sus zonas francas.
- Última actualización: 26/1/2025.
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2025/01/sector_publico_base_caja_diciembre_2024_1.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja-Diciembre. Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Diciembre 2024 - Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
