...
trimestre<-seq(as.Date("2016-04-01"), length = 17,by = "3 months")
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_sep20.xlsx", sheet=2,startRow = 7,colNames=FALSE)
...
```{r}
valueBox("2.8 %", caption = "Inflación del mes de Septiembre-2020", icon="glyphicon-arrow-up",color="skyblue")
```
...
```{r}
valueBox("36.6 %", caption = "Variación interanual", icon="glyphicon-arrow-down",color="orangered")
```

### Acumulada en el año.

```{r}
valueBox("22.3 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
### Variación mensual según divisiones-Septiembre 2020
...
### Variación interanual según divisiones-Septiembre 2020
...
valueBox("1.1 %", caption = "Aumento del EMAE desestacionalizado de Agosto-20 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("-12.5 %", caption = "Variación acumulada del año(Primeros ocho meses - 20) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
...
### Balanza comercial, primeros nueve meses del 2020
...
impo <- tibble(
  ...
  y = c(30378,5072,12139,2248,5200,4402,1072,245),
  drilldown = tolower(name)
)
...
expo <- tibble(
  ...
  y = c(41940,13642,16302,9576,2419),
  drilldown = tolower(name)
)
...
y = c(13,1112,137,553,576,7717,3057,120,17,72,183,86))
...
name = c("Carnes y sus preparados",
  ...
  "Lanas elaboradas",
  "Resto de MOA"),
y=c(2530,156,676,50,77,122,509,3632,151,544,639,6490,143,245,56,282))
...
name= c(  "Productos químicos y conexos",
  ...
  "Resto de MOI"),
y= c(2435,535,120,11,272,70,3,72,1463,966,750,2606,75,198))
...
y=c(1823,346,4975,1532,598,452,244,1285,885))
...
y=c(104,346,424,1684,197,360,228,311,161,117,232,238))
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primeros nueve meses del 2020",style = list( fontSize = '12px')) %>%
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/resultado_fiscal_sep20.xls")
...
hc_title(text="Resultado Fiscal- Base Caja- Septiembre 2020.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja- Septiembre 2020- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
