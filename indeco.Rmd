...
basezonas<-read.xlsx("bases/basezonas33.xlsx", sheet=1)
...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_febrero_2023.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
### Balanza comercial, primer bimestre de 2023
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primer bimestre de 2023",style = list( fontSize = '12px')) %>%
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2023/03/feb_-_23.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja- Febrero 2023.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Febrero 2023- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
