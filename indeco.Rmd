...
```{r}
valueBox("13.1 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
### Tasa de incidencia de la pobreza e indigencia- 1er Semestre 2022- Aglomerados
...
### Pobreza e indigencia-1er semestre 2022-Regiones
...
valueBox("-0.1 %", caption = "Variación del EMAE desestacionalizado de Diciembre-22 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("5.2 %", caption = "Variación acumulada del año(2022) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="orangered")
