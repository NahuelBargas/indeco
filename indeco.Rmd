...
```{r}
valueBox("3.8 %", caption = "Inflación del mes de Octubre-2020", icon="glyphicon-arrow-up",color="skyblue")
```
...
```{r}
valueBox("37.2 %", caption = "Variación interanual", icon="glyphicon-arrow-up",color="orangered")
```

### Acumulada en el año.

```{r}
valueBox("26.9 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
### Variación mensual según divisiones-Octubre 2020
