...
valueBox("1.9 %", caption = "Variación del EMAE desestacionalizado de Abr-25 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("6.3 %", caption = "Variación acumulada del año(2025) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="skyblue")
