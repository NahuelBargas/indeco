...
```{r}
valueBox("101.6 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = " https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_10_24.xls")%>%		 
...
valueBox("1.7 %", caption = "Variación del EMAE desestacionalizado de Jul-24 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("-3.1 %", caption = "Variación acumulada del año(2024) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
...
hc_tooltip(pointFormat =  "{point.y:.1f} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primeros nueve meses de 2024",style = list( fontSize = '12px')) %>%
