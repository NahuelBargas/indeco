...
basezonas<-read.xlsx("bases/basezonas10.xlsx", sheet=1)
...
```{r}
valueBox("13.0 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = " https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_04_21.xls")%>%
...
valueBox("-1.0 %", caption = "Descenso del EMAE desestacionalizado de Febrero-21 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("-2.4 %", caption = "Variación acumulada del año(2021) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
...
### Balanza comercial, primer trimeste del 2021
...
impo <- tibble(
  ...
  y = c(12876,2308,5075,744,2537,1603,497,112
),
  drilldown = tolower(name)
)
...
y = c(7,363,52,138,122,2501,297,41,13,18,104,32
) )
...
name = c("Carnes y sus preparados",
  ...
  "Lanas elaboradas",
  "Resto de MOA"),
y=c(781,56,274,17,13,41,180,1781,58,146,209,3161,62,94,28,95))
...
name= c(  "Productos químicos y conexos",
  ...
  "Resto de MOI"),
y= c(936,174,45,6,97,27,1,33,477,245,290,1287,3,135))
...
y=c(581,303,1738,676,191,230,131,862,365))
...
y=c(53,136,171,515,106,77,79,124,93,50,100,98))
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primer trimestre del 2021",style = list( fontSize = '12px')) %>%
...
- Estados Unidos incluye Puerto Rico y territorios asociados, China a Macao. Chile, Uruguay y Brasil, sus zonas francas.
- Última actualización: 27/3/2021.
