...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_mayo_2023.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
valueBox("-1.9 %", caption = "Variación del EMAE desestacionalizado de Abril-23 con respecto al mes anterior",icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("-0.1 %", caption = "Variación acumulada del año(2023) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
...
### Balanza comercial, primeros cinco meses de 2023
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primeros cinco meses de 2023",style = list( fontSize = '12px')) %>%
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2023/06/may23.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja- Mayo 2023.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Mayo 2023- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
