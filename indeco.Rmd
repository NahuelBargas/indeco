...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_agosto21.xlsx", sheet=2,startRow = 7,colNames=FALSE)
...
### Balanza comercial, primeros ocho meses del 2021
...
impo <- tibble(
  ...
  y = c(40068,6209,16402,3793,7577,4525,1193,369 
...
expo <- tibble(
  ...
  y = c(50717,14634,20786,12392,2906
...
y = c(18,1142,166,417,509,8945,2859,94,33,88,269,94
...
name = c("Carnes y sus preparados",
  ...
  "Lanas elaboradas",
  "Resto de MOA"),
y=c(2176,152,692,43,65,107,515,5947,174,481,604,9018,164,276,75,298
...
name= c(  "Productos químicos y conexos",
  ...
  "Resto de MOI"),
y= c(3241,618,146,17,274,74,4,102,1502,1061,874,3985,158,334
...
y=c(2253,880,6259,2006,563,636,346,2441,1018
...
y=c(148,346,470,1466,329,222,267,337,266,146,265,261
...
hc_tooltip(pointFormat =  "{point.y} millones de dólares") %>%
  hc_colors(cols3)%>%
hc_title(text="Exportaciones por grandes rubros, importaciones por usos y agregados.Balanza comercial, por zonas económicas y países seleccionados. <br> Acumulado primeros ocho meses del 2021",style = list( fontSize = '12px')) %>%
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2021/09/resultado-ago21.xls")
...
hc_title(text="Resultado Fiscal- Base Caja- Agosto 2021.Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Agosto 2021- Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
