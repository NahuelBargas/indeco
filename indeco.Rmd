...
## Resultado fiscal
basecaja<-read.xlsx("bases/resultado_fiscal_agosto2025.xlsx", sheet='IMIG',startRow = 7,colNames=FALSE)
...
```{r}
valueBox("17.3 %", caption = "Acumulada en lo que va del año",  color="skyblue")
```
...
highchart() %>% 
  ...
  style = list(color = "#2b908f", fontSize = '10px'),
             href = " https://www.indec.gob.ar/ftp/cuadros/economia/sh_ipc_09_25.xls")%>%		 
...
### Tasa de incidencia de la pobreza e indigencia- 2ndo Semestre 2024- Aglomerados
...
### Pobreza e indigencia-2ndo semestre 2024-Regiones
...
valueBox("-0.7 %", caption = "Variación del EMAE desestacionalizado de Jun-25 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("6.2 %", caption = "Variación acumulada del año(2025) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-up",color="#43ac6a")
...
hcrs <- highchart() %>%
  ...
  style = list(color = "#2b908f", fontSize = '8px'),href = "https://www.argentina.gob.ar/sites/default/files/2025/09/sector_publico_base_caja_agosto_2025.xlsx")
...
hc_title(text="Resultado Fiscal- Base Caja-Agosto 2025. Millones de pesos",style = list( fontSize = '13px')) %>%
...
hc_title(text="Resultado Fiscal- Base Caja-Agosto 2025 - Variaciones anuales en millones de pesos",style = list( fontSize = '13px')) %>%
