...
```{r}
valueBox("3.2 %", caption = "Inflación del mes de Noviembre-2020", icon="glyphicon-arrow-down",color="skyblue")
```
...
```{r}
valueBox("35.8 %", caption = "Variación interanual", icon="glyphicon-arrow-up",color="orangered")
```

### Acumulada en el año.

```{r}
valueBox("30.9 %", caption = "Acumulada en lo que va del año",  color="yellow")
```
...
valueBox("1.9 %", caption = "Aumento del EMAE desestacionalizado de Octubre-20 con respecto al mes anterior", icon="glyphicon-arrow-up",color="skyblue")
...
valueBox("-11.3 %", caption = "Variación acumulada del año(Primeros diez meses - 20) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
