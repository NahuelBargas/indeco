...
trimestre<-seq(as.Date("2016-04-01"), length = 28,by = "3 months")
...
valueBox("-1.1 %", caption = "Variación del EMAE desestacionalizado de Noviembre-23 con respecto al mes anterior", icon="glyphicon-arrow-down",color="skyblue")
...
valueBox("-1.3 %", caption = "Variación acumulada del año(2023) respecto al acumulado de igual periodo del año anterior", icon="glyphicon-arrow-down",color="orangered")
